...
If the user just says “continue”: wait for 039 user-try / bugs; do not invent a new slice; do **not** start 026, 031, or hyperlink hover. Do not start (6). Do not paste Zed `terminal_element.rs` (GPL-3). Do not start charselect / copy-mode / search / cloned launcher / WSL domains unless asked.
